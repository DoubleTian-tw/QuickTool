Module ProgramAllPath
    ...
    Public Const path_toolProgram As String = "C:\Users\03141\source\repos\Fujitec_SpecTool\WindowsApp1\bin\Debug"
    ...
    Public Const folderName_ppt As String = "ppt"
    Public Const folderName_update As String = "Tool update folder"
    Public Const folderName_updateChinese As String = "更新"
    Public Const folderName_sqlite As String = "SQLite"
    Public Const folderName_sqliteJob As String = "JOB"
    Public Const folderName_userManual As String = "使用者使用說明書"
End Module
